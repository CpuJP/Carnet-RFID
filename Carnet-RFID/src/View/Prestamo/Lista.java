...
import View.Administrador.PersonalULista;
...
public class Lista extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Prestamos registrados en la base de datos");
        ...
        jTable_Prestamos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Prestamo", "Nombre Objeto", "Inicio Prestamos", "Entrega Prestamo", "Origen", "D.I Persona", "ID Carnet"
            }
        ));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        PrestamosController ptc = new PrestamosController();
        try {
            List<Prestamos> pt = ptc.getAllPrestamos();
            DefaultTableModel defaultT = (DefaultTableModel) jTable_Prestamos.getModel();
            int totalFilas = defaultT.getRowCount();
            for (int i = totalFilas -1; i >= 0; i--) {
                defaultT.removeRow(i);
            }
            for(Prestamos p : pt){
                defaultT.addRow(new Object[]{p.getIdPrestamo(), p.getNombreObjeto(), p.getInicioPrestamo(),
                p.getFinalPrestamo(), p.getOrigen(), p.getIdPersona(), p.getIdRfidNfc()});
            }
