 ...
 * @author jp-co
 */
public class AdministradorLista extends javax.swing.JDialog {

    /**
     * Creates new form AdministradorLista
     */
    public AdministradorLista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrativos rregistrados en la Universidad");
        ...
        jTable_Administrativos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "D.I", "Tipo D.I", "Código", "Primer Nombre", "Segundo Nombre", "Primer Apellido", "Segundo Apellido", "Email", "Celular", "Cargo", "Sede"
            }
        ));
        jScrollPane1.setViewportView(jTable_Administrativos);
    ...
    private void jButton_ActualizarTablaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarTablaActionPerformed
        ...
        try {
            List<Administrativo> ad = adc.getAllAdministrativos();
            DefaultTableModel defaultT = (DefaultTableModel) jTable_Administrativos.getModel();
            int totalFilas = defaultT.getRowCount();
            for (int i = totalFilas -1; i >= 0; i--) {
                defaultT.removeRow(i);
            }
            for (Administrativo a : ad){
                defaultT.addRow(new Object[]{a.getIdPersonaAdministrativo(), a.getTipoId(), a.getCodigo(), 
                a.getPrimerNombre(), a.getSegundoNombre(), a.getPrimerApellido(), a.getSegundoApellido(), 
                a.getEmail(), a.getCelular(), a.getCargo(), a.getSede()});
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdministradorLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdministradorLista dialog = new AdministradorLista(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTable_Administrativos;
