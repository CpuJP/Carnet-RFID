...
use carnet;
insert into carnet.rfid_nfc values('000');
...
insert into carnet.prestamos (nombre_objeto, inicio_prestamo, origen, id_persona, id_rfid_nfc) values ('Balón voleibol', '2022-04-01 20:27:40', 'Bienestar', '1007668974', '12345');
insert into carnet.sala_computo values ('2022-04-01 20:27:40', '2022-04-01 20:27:40', '201', '3958398583975', '1007668974', '12345');
...
use carnet;
Select * from personal_universidad where primer_apellido like '[G]%';
